...
class CardDetailViewModel(
    ...
    private val _listOfSymbols = MutableLiveData<List<SymbolGuideItem.SymbolForWashing>>()
    val listOfSymbols: LiveData<List<SymbolGuideItem.SymbolForWashing>> = _listOfSymbols
